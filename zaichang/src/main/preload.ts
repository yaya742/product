...
const bridge: Bridge = {
  ...
  importCampus: () => ipcRenderer.invoke('campus:import'),
  disconnectCampus: () => ipcRenderer.invoke('campus:disconnect'),
  campusTemplate: () => ipcRenderer.invoke('campus:template'),
  connectCampusAccount: () => ipcRenderer.invoke('campus:account:connect'),
  configureCampusConnector: () => ipcRenderer.invoke('campus:connector:configure'),
  disconnectCampusConnector: () => ipcRenderer.invoke('campus:connector:disconnect'),
  configureCampusCredentials: () => ipcRenderer.invoke('campus:connector:credentials'),
  forgetCampusCredentials: () => ipcRenderer.invoke('campus:connector:forget-credentials'),
  mapLocate: () => ipcRenderer.invoke('map:locate'),
  mapStopLocation: () => ipcRenderer.invoke('map:location-stop'),
  mapOverview: () => ipcRenderer.invoke('map:overview'),
  mapSearch: (input) => ipcRenderer.invoke('map:search', input),
  mapLocationStatus: () => ipcRenderer.invoke('map:location-status'),
  mapRoute: (input) => ipcRenderer.invoke('map:route', input),
