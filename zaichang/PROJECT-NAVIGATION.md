...
本文件是职责、当前策略、集成状态和实际文件索引的唯一维护位置。它不是学生运行时资料，也不是永久架构。检查日期：2026-09-19（Asia/Shanghai），应用 **0.3.0**。本次基线 HEAD 为 `08f95f633536fb119c5dd7c9206ccd3aa22ab81b`，工作区有大量此前未提交改动。
